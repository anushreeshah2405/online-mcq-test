...
<ul>
  ...
  <li><font size="7">QUESTION LIST</font></li>
...
<div>
  ...
  <input type="text" name="update_id" placeholder="QUESTION ID" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="UPDATE">
<br><br><br>

<?php 
$sql="SELECT id,subject_id,teacher_id,question,a,b,c,d,correctans FROM qb order by subject_id";
...
<th col width="90">Question_ID</th>
<th>Subject_id</th>
<th>Teacher_id</th>
<th col width="300">Question</th>
<th>Option A</th>
<th>Option B</th>
<th>Option C</th>
<th>Option D</th>
<th col width="60">Correct Option</th>
