...
<script type="text/javascript">
    	function clientside_validate()
		{
					...
					var emailid		= $.trim($('input[name="update_id"]').val());
					
					//alert(username+'###'+password);
					//return false;
					
					
					if(emailid != '<?php echo($row['emp_id']) ?>')
					{
						alert('Plz select valid employee id');
						return false;
					}
					else
					{
						location.href = 'update_emp.php';
					}
...
<ul>
  ...
  <li><font size="7">EMPLOYEE LIST</font></li>
...
<div>
  <form id="frm_update" action="update_emp.php" method="post">
  <input type="text" name="update_id" placeholder="EMPLOYEE ID" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="submit" value="UPDATE" >
<br><br><br>
<?php 

$sql="SELECT id,emp_id,name,dob,gender,contact,email FROM employee where status='1'";
...
<th>Employee ID</th>
<th col width="200">Name</th>
<th>Date Of Birth</th>
<th>Gender</th>
<th>Contact No</th>
<th col width="350">Email ID</th>
</tr>';
